package com.serpilozguven.javaworkmanager;
...
public class RefreshDatabase extends Worker {
    ...
    private void refreshDatabase(int myNumber) {
        SharedPreferences sharedPreferences = myContext.getSharedPreferences("com.serpilozguven.javaworkmanager", Context.MODE_PRIVATE);
